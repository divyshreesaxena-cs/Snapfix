...
const Payment = () => {
  ...
  const handlePayment = async (e) => {
    ...
    setProcessing(true);
    try {
      const createResponse = await paymentsAPI.createPayment({
      ...
      if (!paymentId) {
        throw new Error('Payment intent was created, but no payment ID was returned');
      }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-dark-600 text-lg">
            Review the invoice and complete your payment
          </p>
        </motion.div>
            ...
            <form onSubmit={handlePayment} className="card p-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-dark-500">
                  Minimum 0.5 hours, billed in 0.5 hour increments.
                </p>
              </div>
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 text-blue-900 flex gap-3">
                <ShieldCheck className="w-5 h-5 mt-0.5 flex-shrink-0" />
                <div className="text-sm">
                  This demo now creates a pending payment record first, then confirms it. That keeps the
                  payment flow separate from invoice creation instead of marking everything completed instantly.
                </div>
              </div>
