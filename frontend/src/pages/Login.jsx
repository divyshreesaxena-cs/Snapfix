...
const Login = () => {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      navigate(currentRole === 'worker' ? '/worker/dashboard' : currentRole === 'admin' ? '/admin/dashboard' : '/home');
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <p className="text-center mt-3 text-sm text-dark-500">
          Need admin access? <a href="/admin/login" className="text-orange-600 font-semibold">Admin Login</a>
        </p>
      </div>
    </div>
  );
